...
verified admissibility a posteriori on a dense grid of $20\,001$
intermediate points: the maximum level is $\ell\approx0.921$, with no
violations, consistently with Table~\ref{tab:ellipse-continuation}.
...
confirmed on a dense validation grid of $20\,001$ points (cf.\ the level
